"""E2 Modal train+eval: matched decision/backtrack policies.

Same flow as `experiments/sudoku/run.py`, but attaches step/search/pool
strategies from this package before calling shared `train()` / `solve()`.
"""
...
app = modal.App("followup-e2-train")
